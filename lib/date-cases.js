 ...
 * @returns {Array.<Number>}
 */
function findAllMatchingParsedTimes(allowedTypes, step, start, expressions, parsedTimes, ignoreValidMode, ignorePrepositions) {
   if (typeof (ignoreValidMode) == 'undefined') {
      ignoreValidMode = ValidModes.certified;
   }
   if (typeof (ignorePrepositions) == 'undefined') {
