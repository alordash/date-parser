...
class ParsedTime {
     ...
     */
    constructor(number, value, indexes, prevalence) {
        this.number = number;
        this.value = value;
    ...
    new ParseCase(10, function findSeconds(timeList, prevalence) {
        ...
        if (matches != null) {
            ...
            while (!(match = matches.next()).done) {
                ...
                timeList.seconds.push(new ParsedTime(+this.expressions[match.index].text, this.expressions[match.index + 1].value, indexes, prevalence));
            }
            return timeList;
        }
        return 0;
    ...
    new ParseCase(10, function findMinutes(timeList, prevalence) {
        ...
        if (matches != null) {
            ...
            while (!(match = matches.next()).done) {
                match = match.value;
                let indexes = replaceWithDots.call(this, match.index, 2, true);
                timeList.minutes.push(new ParsedTime(+this.expressions[match.index].text, this.expressions[match.index + 1].value, indexes, prevalence));
            }
            return timeList;
        }
        return 0;
    ...
    new ParseCase(10, function findDates(timeList, prevalence) {
        ...
        if (matches != null) {
            ...
            while (!(match = matches.next()).done) {
                match = match.value;
                let indexes = replaceWithDots.call(this, match.index, 2, true);
                timeList.dates.push(new ParsedTime(+this.expressions[match.index].text, this.expressions[match.index + 1].value, indexes, prevalence));
            }
            return timeList;
        }
        return 0;
    ...
    new ParseCase(10, function findMonths(timeList, prevalence) {
        ...
        if (matches != null) {
            ...
            while (!(match = matches.next()).done) {
                match = match.value;
                let indexes = replaceWithDots.call(this, match.index, 2, true);
                timeList.months.push(new ParsedTime(+this.expressions[match.index].text, this.expressions[match.index + 1].value, indexes, prevalence));
            }
            return timeList;
        }
        return 0;
    ...
    new ParseCase(10, function findYears(timeList, prevalence) {
        ...
        if (matches != null) {
            ...
            while (!(match = matches.next()).done) {
                match = match.value;
                let indexes = replaceWithDots.call(this, match.index, 2, true);
                timeList.years.push(new ParsedTime(+this.expressions[match.index].text, this.expressions[match.index + 1].value, indexes, prevalence));
            }
            return timeList;
        }
        return 0;
    ...
    new ParseCase(10, function findYearsSmall(timeList, prevalence) {
        ...
        if (matches != null) {
            ...
            while (!(match = matches.next()).done) {
                ...
                let indexes = replaceWithDots.call(this, match.index, 2, true);
                timeList.years.push(new ParsedTime(num, this.expressions[match.index + 1].value, indexes, prevalence));
            }
            return timeList;
        }
        return 0;
