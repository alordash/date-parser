 ...
 */
function parseDate(string, errorLimit, minimumPrevalence, originalString) {
   ...
   let originalWords;
   let words = originalWords = string.split(/ +/);
   ...
   return parse(convertedWords, originalWords, errorLimit, minimumPrevalence);
}
