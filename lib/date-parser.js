...
function parseDate(string, errorLimit, minimumPrevalence) {
   ...
   let newContexts = fillNotUsedContexts.call(parsedDates, notUsedContexts, contextsData, expressions, 'I', undefined);
   let separators = LoadSeparators();
   while (newContexts.length != notUsedContexts.length) {
