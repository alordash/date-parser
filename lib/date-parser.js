...
const { ConvertedWord, extractRegexChars } = require('./regex-extractor');
...
function parseDate(string, errorLimit, minimumPrevalence) {
   ...
   return parse(convertedWords, errorLimit, minimumPrevalence);
}
 ...
 */
function parse(words, errorLimit, minimumPrevalence) {
