...
const { isDateType, isTimeType, getDateProperty, ValidModes, ParsedTime, ContextsData, extractTime, TimeTypes } = require('./date-cases');
...
class ParsedDate {
   ...
   valueOf() {
      const now = new Date();
      removeUTCOffset.call(now);
      const date0 = new Date(0);
      removeUTCOffset.call(date0);
